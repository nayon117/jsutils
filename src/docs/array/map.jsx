...
const mapMethod = () => {
  return (
    <div>
      ...
      <h2 className="text-xl font-semibold mb-3">Problem Solving with .map()</h2>

      <h3 className="text-lg font-semibold">Problem 1: Convert an array of strings to uppercase.</h3>
      ...
      <h3 className="text-lg font-semibold">Problem 2: Extract names from an array of objects.</h3>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li className="mt-3">Exercise 2: Use .map() to multiply each number in an array by its index (e.g., [5, 10, 15] should become [0, 10, 30]).</li>
      </ul>
    </div>
  );
};
